...
public final class IncorporeticBlocks {
	...
	public static final BlockWildcardCorporeaInterceptor CORPOREA_INTERCEPTOR_OMNI = null;
	...
	public static void registerBlocks(IForgeRegistry<Block> reg) {
		...
		reg.register(createBlock(new BlockWildcardCorporeaInterceptor(), RegistryNames.CORPOREA_INTERCEPTOR_OMNI));
